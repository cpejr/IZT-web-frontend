  ...
  return (
    <Container>
      ...
      <SideContainer>
        ...
        <SocialMedias>
          <SocialMediaButton
            href="https://www.instagram.com/iztcore/"
            target="_blank"
          >
            <BsInstagram size={30} />
          </SocialMediaButton>
          <SocialMediaButton href="" target="_blank">
          ...
          <SocialMediaButton
            href="https://api.whatsapp.com/send/?phone=%2B5531993912235&text&type=phone_number&app_absent=0"
            target="_blank"
          >
            <BsWhatsapp size={30} />
          </SocialMediaButton>
