...
export const createProductValidationSchemaEN = z.object({
  ...
  category: z.string({ required_error: 'Please select a category' }), // Here we need to pass the category id only
  description: z
    .string()
  ...
  pictures: z
    ...
    .nonempty('You must insert at least one photo')
...
export const toastSuccessMessageEN = 'Product created successfully!';
...
const getCategoriesIdDefaultErrorMessageEN =
  'An error occurred while listing categories. Please try again later';
